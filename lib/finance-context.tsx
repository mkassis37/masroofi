...
export function formatMoney(value: number, symbol = "د.أ", language: "ar" | "en" = "ar", numberStyle: "arabic-indic" | "western" = language === "ar" ? "arabic-indic" : "western") { return `${formatNumber(value, language, numberStyle)} ${symbol}`; }
